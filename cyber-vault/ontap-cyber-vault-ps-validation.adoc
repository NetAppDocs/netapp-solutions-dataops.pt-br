...
image:ontap-cyber-vault-connections.png["Verifique se não há conexões com o cofre cibernético"]

Esta captura de tela mostra que não há possibilidade de adulterar os instantâneos.

image:ontap-cyber-vault-tamperproof-snapshots.png["Verifique se não há capacidade de adulterar cópias do Snapshot"]
