...
summary: Esta solução é baseada em um cliente que precisa copiar dados com base em uma data específica. 
---
= Digitalização e cópia de dados com base em data específica
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Esta solução é baseada em um cliente que precisa copiar dados com base em uma data específica.  Verifique os seguintes detalhes:
