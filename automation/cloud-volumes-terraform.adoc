...
summary: 'Esta página descreve o método automatizado para implantar volumes Netapp em provedores de nuvem (AWS, Azure, GCP) usando o Terraform.' 
---
...
A documentação do provedor Terraform para o Cloud Manager está disponível em:link:https://registry.terraform.io/providers/NetApp/netapp-cloudmanager/latest/docs["https://registry.terraform.io/providers/NetApp/netapp-cloudmanager/latest/docs"]
